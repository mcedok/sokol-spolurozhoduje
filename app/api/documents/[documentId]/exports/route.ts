import { z } from "zod";
import {
  pdfExportFiltersSchema,
  pdfExportInternalOptionsSchema,
  pdfExportVisibilitySchema,
} from "../../../../../contracts";
...
const schema = z.object({
  ...
  filters: pdfExportFiltersSchema.optional().default({ statuses: [], priorities: [], types: [] }),
  options: pdfExportInternalOptionsSchema.optional().default({
...
export async function POST(
  ...
  try {
    ...
    const job = await getIdentityRuntime().exports.createExport(actor, documentId, {
      ...input,
